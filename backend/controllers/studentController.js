...
const updateStudent = async (req, res) => {
    ...
    try {
        ...
        const { name, cms_id, room_no, batch, dept, course, email, father_name, contact, address, dob, user, hostel } = req.body;
...
const csvStudent = async (req, res) => {
    ...
    try {
        ...
        const fields = ['name', 'cms_id', 'room_no', 'batch', 'dept', 'course', 'email', 'father_name', 'contact_no', 'address', 'd_o_b', 'hostel_name'];
